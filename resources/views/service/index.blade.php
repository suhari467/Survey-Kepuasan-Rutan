        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              ...
              @endif
              <a href="{{ route('layanan.create') }}" class="btn btn-success mt-2 mb-2"><span class="fas fa-plus"></span> Tambah Layanan</a>           
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <form action="{{ url('layanan') }}/{{ $service->id }}" id="hapusForm-{{ $service->id }}" method="post" class="d-inline">
                        @method('delete')
                        @csrf
                        <button class="btn btn-danger btn-sm border-0 hapus-item" type="button" name="hapusId" value="{{ $service->id }}"><span class="fas fa-trash"></span> Hapus</button>
                      </form>
                  </td>
                  </tr>
                  @endforeach
...
<script type="text/javascript">
  ...
  $(".hapus-item").on("click", function() {
    var id = $(this).val();
      ...
      Swal.fire({
        title: 'Perhatian!',
        text: 'Apakah ingin menghapus layanan tersebut ?',
        icon: 'warning',
