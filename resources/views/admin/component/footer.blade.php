...
<!-- /.modal -->
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; {{ date('Y') }} <a href="" data-toggle="modal" data-target="#modal-contact"> {{ session()->get('nama_instansi') ? ucwords(strtolower(session()->get('nama_instansi'))) : 'Aplikasi Survey Kepuasan Pelanggan'}}</a>.</strong> All rights reserved.
  </footer>